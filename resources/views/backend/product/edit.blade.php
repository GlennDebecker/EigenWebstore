                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-10 m-auto">
                            <form action="{{ route('products.edit.store-product',$product->id) }}" method="POST" class="form-horizontal" enctype="multipart/form-data" autocomplete="off">
                            @csrf
                            @method('PUT')
                                <div class="form-group row">
                                    <label class="col-sm-3" for="name">Product name<span class="text-danger">*</span></label>
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control" id="fname" name="name" value="{{ $product->name }}" placeholder="Enter the Product name" required autocomplete="off">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-2">
                                        <input type="text" class="form-control" id="CPU" name="CPU" value="{{ $product->CPU }}" placeholder="Enter the Processor info" required autocomplete="off">
                                        <small> CPU</small>
                                        @if ($errors->has('CPU'))
                                    ...
                                    <div class="col-sm-2">
                                        <input type="number" class="form-control" id="RAM" name="RAM" value="{{ $product->RAM }}" placeholder="Enter the RAM Capacity" required autocomplete="off">
                                    ...
                                    <div class="col-sm-2">
                                        <input type="number" class="form-control" id="storage" name="storage" value="{{ $product->storage}}" placeholder="Enter the Disc Storage " required autocomplete="off">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea type="text" class="form-control" id="Pros" name="pros"  placeholder="Pros" style="white-space: pre-wrap;" required autocomplete="off">{{ $product->pros }}</textarea>
                                        @if ($errors->has('pros'))
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea type="text" class="form-control" id="cons" name="cons"  placeholder="cons" style="white-space: pre-wrap;" required autocomplete="off">{{ $product->cons }}</textarea>
                                        @if ($errors->has('cons'))
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea type="email" class="form-control" id="description" name="description" style="white-space: pre-wrap;"  placeholder="Enter the product description" required autocomplete="off">{{ $product->description }}</textarea>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="file" class="form-control"  name="images[]" multiple   autocomplete="off">
